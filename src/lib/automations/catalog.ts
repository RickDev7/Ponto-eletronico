...
export const AUTOMATION_TRIGGERS: TriggerDef[] = [
  ...
  {
    type: "lead.qualified",
    labelKey: "triggers.leadQualified",
    descriptionKey: "triggers.leadQualifiedDesc",
    fields: [{ key: "estimatedValueCents", labelKey: "fields.amount", type: "number" }],
    exampleFlowKey: "examples.leadQualified",
  },
  {
  ...
  {
    type: "quote.sent",
    labelKey: "triggers.quoteSent",
    descriptionKey: "triggers.quoteSentDesc",
    fields: [{ key: "totalCents", labelKey: "fields.amount", type: "number" }],
    exampleFlowKey: "examples.quoteSent",
  },
  {
    type: "quote.submitted",
    labelKey: "triggers.quoteSubmitted",
    descriptionKey: "triggers.quoteSubmittedDesc",
    fields: [{ key: "totalCents", labelKey: "fields.amount", type: "number" }],
    exampleFlowKey: "examples.quoteSubmitted",
  },
  {
    type: "quote.approved",
    labelKey: "triggers.quoteApproved",
    descriptionKey: "triggers.quoteApprovedDesc",
    fields: [{ key: "totalCents", labelKey: "fields.amount", type: "number" }],
    exampleFlowKey: "examples.quoteApproved",
  },
  {
    type: "shift.empty",
