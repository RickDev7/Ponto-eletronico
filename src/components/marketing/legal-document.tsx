...
export async function LegalDocument({ namespace, className }: LegalDocumentProps) {
  ...
  return (
    <article className={cn("mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20", className)}>
      <header className="mb-12 border-b border-[#E2E8F0] pb-10">
        <p className="mb-3 text-xs font-medium uppercase tracking-[0.16em] text-[#64748B]">
          {t("eyebrow")}
        </p>
        <h1 className="mb-4 text-3xl font-semibold tracking-tight text-[#0F172A] sm:text-4xl">
          {t("title")}
        </h1>
        <p className="text-[15px] leading-relaxed text-[#64748B]">{t("description")}</p>
