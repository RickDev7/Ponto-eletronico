...
export function ContactForm() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="space-y-5 rounded-2xl border border-white/[0.08] bg-zinc-900/60 p-6 backdrop-blur-xl sm:p-8"
    >
      <div className="space-y-2">
        ...
        <Input
          ...
          name="name"
          required
          className="h-12 border-white/[0.08] bg-white/[0.04] text-white"
        />
      </div>
      <div className="space-y-2">
